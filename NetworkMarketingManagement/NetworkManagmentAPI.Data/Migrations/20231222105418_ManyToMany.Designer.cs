...
namespace NetworkManagmentAPI.Data.Migrations
{
    ...
    [Migration("20231222105418_ManyToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetworkManagementAPI.Entities.DistributorAddressContactPersonalIdentifier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PersonalIdentifierId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PersonalIdentifierId");

                    b.ToTable("DistributorAddressContactPersonalIdentifiers");
                });
            ...
            modelBuilder.Entity("NetworkManagementAPI.Entities.DistributorAddressContactPersonalIdentifier", b =>
                {
                    b.HasOne("NetworkManagementAPI.Entities.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NetworkManagementAPI.Entities.ContactInfo", "ContactInfo")
                        .WithMany()
                    ...
                    b.HasOne("NetworkManagementAPI.Entities.PersonalIdentifier", "PersonalIdentifier")
                        .WithMany()
                        .HasForeignKey("PersonalIdentifierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
